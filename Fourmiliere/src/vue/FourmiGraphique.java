...
public class FourmiGraphique implements ElementGraphique {
  ...
  protected final int tailleFourmi = 1; // taille defaut d'une FourmiGraphique.
   ...
   * apparait a 4 points différents de la fourmilière(haut, bas, gauche ou droite de la
   * fourmiliere).
   * 
