 ...
 * homologue graphique FourmiGraphique. Poss�de une TerritoireGraphique.
 * 
 * @author Damien
 *
 */
public class FourmiliereGraphique implements ElementGraphique {
   ...
   * @return la valeur de l'association supprim�e.
   */
  ...
  /**
   * D�place dans la vue l'elementGraphique d'une FourmiGraphique du HashMap.
   * 
   * @param fourmi clef de l'association de la la fourmiGraphique a d�placer.
